    ...
    <section className="min-h-screen flex flex-col justify-center pt-20 px-6 md:px-10">
      <div className="max-w-7xl mx-auto w-full">
        <div className="space-y-8 md:space-y-10">
          ...
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-display font-bold leading-tight tracking-tight animate-slide-down" style={{ animationDelay: '0.3s', animationFillMode: 'forwards' }}>
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl animate-slide-down" style={{ animationDelay: '0.7s', animationFillMode: 'forwards' }}>
